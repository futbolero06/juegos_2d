...
# diibujar circulo
circ_1 = c.create_oval( BASE/2,0,BASE,ALTURA/2, fil="blue")
...
polig_4 =c.create_polygon(BASE/2-50,ALTURA/2-75,BASE/2+50,ALTURA/2-75,BASE/2+50,ALTURA/2-75,BASE/2+50,ALTURA/2-25,BASE/2+50,ALTURA/2-25,BASE/2+100,ALTURA/2-25,BASE/2+100,ALTURA/2-25,BASE/2+100,ALTURA/2+25,BASE/2+100,ALTURA/2+25,BASE/2+50,ALTURA/2+25,BASE/2+50,ALTURA/2+25,BASE/2+50,ALTURA/2+75,BASE/2+50,ALTURA/2+75,BASE/2-100,ALTURA/2+75,fill="red", outline="green")
